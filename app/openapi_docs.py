...
ENTITY_TERMS = {
    ...
    "inbound-receipts": ("Приёмка", "документов приёмки", "документ приёмки"),
...
ACTION_LABELS = {
    ...
    "place": "разместить",
    "putaway": "разместить принятый товар",
    "move": "переместить",
    ...
    "returns": "оформить возврат по исходной выдаче",
    "write-off": "списать ответственность по нормативу",
    "write-offs": "получить нормативные списания",
    "quantity": "распределить количество",
    "reserve-quantities": "зарезервировать количества",
    "pick-quantities": "отобрать количества",
    "load-quantities": "подтвердить количественную погрузку",
    "dispatch-quantities": "отправить количества в путь",
    "receive-quantities": "принять количества на складе назначения",
